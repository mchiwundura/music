...
let electric_lead = note(mainriff).s("gm_overdriven_guitar").gain(0.2)
...
let leadend = note("[g#3, c#4, g#4] _ _ [g#3, c#4, g#4] _ _ _ [c#4, g#4, c#5] _ [c#4, g#4, c#5] _").s("gm_acoustic_guitar_nylon")

arrange(
	[1.5, lead],
	[0.5, stack(stack(kick3, snare3, hi_hat3).cpm(112 / 4), leadend.cpm(116/4))],
	[4, stack(lead, kick, crash, snare, kickdelay, bass, electric_lead)],
	[4, stack(bass2, kick2, snare2, electric_lead2)]
)._pianoroll()